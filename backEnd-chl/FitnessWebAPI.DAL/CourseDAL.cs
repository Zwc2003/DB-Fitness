    ...
    public class CourseDAL
    {
        ...
        public static int Insert(Course course, OracleTransaction transaction = null)
        {
            try
            {
                ...
                string sql = $"INSERT INTO \"Course\"( \"typeID\", \"courseName\", \"Capacity\", \"courseDescription\", \"coursePrice\", \"courseStartTime\", \"courseEndTime\", \"courseLastDays\", \"courseGrade\", \"coursePhotoUrl\") " +
                             $"VALUES(:typeID, :courseName, :Capacity, :courseDescription, :coursePrice, :courseStartTime, :courseEndTime, :courseLastDays, :courseGrade, :coursePhotoUrl) "+
                ...
                {
                    Console.WriteLine($"Parameter: {param.ParameterName}, Value: {param.Value}, OracleDbType: {param.OracleDbType}");
                }
        ...
        public static bool UpdateByClassID(Course course)
        {
            try
            {
                string sql = "UPDATE \"Course\" SET \"typeID\"=:typeID, \"courseName\"=:courseName, \"Capacity\"=:Capacity, \"courseDescription\"=:courseDescription, \"coursePrice\"=:coursePrice, \"courseStartTime\"=:courseStartTime, \"courseEndTime\"=:courseEndTime, \"courseLastDays\"=:courseLastDays, \"courseGrade\"=:courseGrade, \"coursePhotoUrl\"=:coursePhotoUrl WHERE \"classID\"=:classID";
