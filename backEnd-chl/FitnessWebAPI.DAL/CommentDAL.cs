...
namespace FitnessWebAPI.DAL
{
    ...
    public class CommentDAL
    {
        ...
        {
            string query = "INSERT INTO \"Comment\" (\"userID\", \"postID\", \"parentCommentID\", \"commentTime\", \"likesCount\", \"Content\")"+ 
                "VALUES(:userID, :postID, :parentCommentID, :commentTime, :likesCount, :Content)";
