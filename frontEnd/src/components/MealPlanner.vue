...
export default defineComponent({
    data() {
        return {
            ...
            recipes: [
               /* {
                    recipeID: 1, image: diet1, title: '阿特金斯饮食法', content: `阿特金斯饮食法 是美国医生罗伯特 . 阿特金斯(Robert Atkins）于1970年提出的低碳水减肥方法，他认为减重的关键是限制碳水化合物的摄取，而可以吃高蛋白的食品，而多吃肉类、鱼，类似生酮饮食，从而将人体从消耗碳水化合物的代谢转化成以消耗脂肪为主的代谢模式。

                如何进行阿特金斯饮食法

原理：以低比例的碳水化合物摄取量改变人体产生能量的来源，转而消耗脂肪。

阿特金斯饮食法共分为四个不同阶段：

阶段1: 诱导
每天少于20克碳水化合物，持续2周。多吃高脂肪，高蛋白质的低碳蔬菜，如绿叶蔬菜。这开始减肥。

阶段 2: 平衡
慢慢在饮食中添加更多坚果，低碳水化合物蔬菜和少量水果。

阶段3：微调
当您非常接近目标体重时，请在饮食中添加更多的碳水化合物，直到减慢体重。

阶段4：维护
在这里，您可以摄取尽可能多的健康碳水化合物，而无需增加体重。
...
＊肉类：牛肉，猪肉，羊肉，鸡肉，培根等
＊肥鱼和海鲜：鲑鱼，鳟鱼，沙丁鱼等
＊鸡蛋：最健康的鸡蛋富含或富含omega-3
＊低碳水化合物蔬菜：羽衣甘蓝，菠菜，西兰花，芦笋等
＊全脂乳制品：黄油，酪，奶油，全脂酸奶
＊坚果和种子：杏仁，夏威夷果，核桃，葵花籽等
＊健康脂肪：特级初榨橄榄油，椰子油，牛油果和牛油果油。`, releaseTime: '2024.8.5 13:40'
                },
                { recipeID: 2, imgUrl: diet2, title: '地中海饮食法', content: '地中海饮食法（Mediterranean diet)，是融合了地中海沿岸国家的饮食模式与生活习惯的一种饮食方法。总的来说，该饮食方法富含蔬菜、水果、豆类、坚果、豆类、谷类、谷物、鱼和不饱和脂肪...', releaseTime: '2024.8.5 13:40' },
                { recipeID: 3, imgUrl: diet3, title: 'CRD饮食法', content: 'CRD即限能量平衡膳食减肥法，在营养均衡的基础上，维持身体能量负平衡状态。对血糖稳定以及内脏脂肪减少有积极意义，且对于延长寿命、延迟衰老相关疾病的发生具有明确干预作用。', releaseTime: '2024.8.5 13:40' },
           */ ],
