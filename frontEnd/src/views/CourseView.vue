...
>{{ activity.title }} <span class="tag">{{ activity.tagText }}</span></div>
<!-- 活动导师 
      ...
      <!-- 报名按钮 
      <el-button @click="toggleSignUp(activity)" type="primary" class="signup-button">{{ activity.isSignedUp ? '取消报名' :
      '报名' }}</el-button>
    </el-card>
  </div>
</template>
